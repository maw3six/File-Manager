...
if (!isset($_SESSION['authenticated']) || $_SESSION['authenticated'] !== true) {
    if (isset($_COOKIE['auth_token']) && password_verify($hashed_password, $_COOKIE['auth_token'])) {
		...
		<center><form method="POST" style="text-align:center;margin-top:20px;"><input type="password" name="password" required style="border:none;outline:none;background:transparent;font-size:16px;"></center>	
