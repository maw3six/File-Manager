...
define('APP_TITLE', 'Hello Friend ~');

$use_auth = true;

$auth_users = array(
    'admin' => '$2y$10$GqknXKS2D83TgGAlyWdz.uV0o0mSFug0XTc.71xvYz3sP8yyHVWc.', //admin@123
    'elliot' => '$2y$10$Nwd0oy7T6HX6PNvZqPcJUeCDleRMbgyLixP/QjPUgI5551dGk6Idm' //12345
);
...
$max_upload_size_bytes = 10000000; // size 5,000,000,000 bytes (~5GB)
                ...
                <div class="row justify-content-md-center align-content-center h-100vh">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="#" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">Hello Friends~</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> Hello Friend ~ <?php echo VERSION; ?></a></h3>
                        </p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY): ?>
            ...
            <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Hello Friend ~ <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Hello Friend ~ <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Hello Friend ~<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
?>
    ...
    <head>
        ...
        <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Hello Friend ~">
        ...
        <style>
            body.fm-login-page {
                ...
                font-size: 14px;
                background-color: #f7f9fb;
                background-image: url("https://img.freepik.com/free-vector/psychedelic-optical-illusion-background_52683-39372.jpg");
            }
